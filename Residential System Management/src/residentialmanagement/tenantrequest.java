 ...
 * @author omben
 */
public class tenantrequest extends Application {
    
    static Stage  tenantrequestStage = new Stage();
   
    @Override
    public void start(Stage tenantrequestStage) {
        ...
        tenantrequestStage.setTitle("Reset Password");
        ...
        tenantrequestStage.setScene(my_scene);  
       
        tenantrequestStage.show();
        ...
        back_btn.setOnMouseClicked((new EventHandler<MouseEvent>(){
         ...
         public void handle(MouseEvent event) {
             ...
             try
             {
                ...
                String query = "INSERT INTO `tenant_password_change` (`Tenant_id`,`Email`,`New_password`) VALUES ('"+tenant+"','"+email+"','"+new_pass+"'); ";
