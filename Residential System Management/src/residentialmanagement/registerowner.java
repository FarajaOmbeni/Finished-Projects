...
public class registerowner extends Application {
    
    static Stage  registerownerStage = new Stage();
   
    @Override
    public void start(Stage registerownerStage) {
        ...
        Label property_lbl = new Label("House Number");
        ...
        TextField property_txt = new TextField();
        ...
        gridPane.add(property_lbl, 1,5);
        gridPane.add(property_txt, 2,5);
        ...
        registerownerStage.setTitle("REGISTER OWNER");
        ...
        registerownerStage.setScene(my_scene);  
       
        registerownerStage.show();
        ...
        register_btn.setOnMouseClicked((new EventHandler<MouseEvent>() {
         public void handle(MouseEvent event) {
            ...
            String property = property_txt.getText();
             ...
             try
             {
                ...
                String query = "INSERT INTO `owner` (`First_name`, `Last_name`, `Phone_number`, `Email`, `Password`, `Property`) VALUES ('"+firstname+"', '"+lastname+"', '"+tel+"', '"+email+"', '"+password+"', '"+property+"'); ";
