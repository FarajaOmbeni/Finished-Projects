...
import static residentialmanagement.owner.ownerStage;
import static residentialmanagement.ownerrequest.ownerrequestStage;
    ...
    public void start(Stage ownerloginStage) {
        ...
        edit_btn.setOnMouseClicked((new EventHandler<MouseEvent>(){
                public void handle(MouseEvent event){
                    ownerrequest a = new ownerrequest();
                    a.start(ownerrequestStage);
                    
                    ownerloginStage.close();
                }
               }));
        ...
        back_btn.setOnMouseClicked((new EventHandler<MouseEvent>(){
         ...
         public void handle(MouseEvent event) {
             ...
             try
             {
                ...
                String query = "SELECT * FROM residential_management_system.owner Where Email = '"+email+"' AND Password = '"+password+"' ";
