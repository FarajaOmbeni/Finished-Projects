                      ...
                      <br><br>
                            ...
                            <?php
                                if(isset($_POST['update'])){
                                    $user_id = $_GET['user_id'];
                                    $sql = "UPDATE `seller` SET first_name='$_POST[first_name]', last_name='$_POST[last_name]', email='$_POST[email]',`password`='$_POST[password]',phone_number='$_POST[phone_number]' WHERE `user_id`='$user_id'";
