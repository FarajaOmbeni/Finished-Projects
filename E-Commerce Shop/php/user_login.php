    ...
    <body>
        ...
        <section class="clothes">
            ...
            <div class="shopping">
                <div class="announcement-row">
                    ...
                    <a class="category-link" href="categories.php"><h3>SHOP CATERGORIES.</h3>
                        <p>Men, Women and Children!</p></a>
                </div>
                <div class="catergory-col">
                    <a  class="category-link"href="view_men.php"><h3>MEN'S WEAR.</h3>
                        <p>Shirts, Shorts, Suits, Shoes, and Many More!</p></a>
                </div>
                <div class="women.html">
                    <a class="category-link" href="view_women.php"><h3>WOMEN'S WEAR.</h3>
                        <p>Shirts, Shorts, Suits, Shoes, and Many More!</p></a>
                </div>
                <div class="catergory-col">
                    <a class="category-link" href="view_children.php"><h3>CHILDREN'S CORNER.</h3>
                        <p>Shirts, Shorts, Suits, Shoes, and Many More!</p></a>
                </div>
            </div>
            </div>
        ...
        <div class="row">
            <div class="clothes-col">
                ...
                <a href="view_men.php"><div class="layer"><h1>For Men</h1></div></a>
            </div>
            <div class="clothes-col">
                <img src="../images/forwomen.webp">
                <a href="view_women.php"><div class="layer"><h1>For Women</h1></div></a>
            </div>
            <div class="clothes-col">
                <img src="../images/forkids.webp">
                <a href="view_children.php"><div class="layer"><h1>For Kids</h1></div></a>
            </div>
        </div>
